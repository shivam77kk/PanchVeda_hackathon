...
const AddItemModal: React.FC<AddItemModalProps> = ({ onClose }) => {
  ...
  const categories = ['Oils', 'Herbs', 'Equipment', 'Medicines', 'Supplements'];
  const units = ['bottles', 'kg', 'grams', 'pieces', 'liters', 'boxes'];
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Supplier & Pricing */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-gray-800">Supplier & Pricing</h3>
