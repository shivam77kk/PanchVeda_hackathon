      ...
      <div className="min-h-screen bg-green-50 dark:bg-gray-900">
        ...
        <div className="bg-gray-100 dark:bg-gray-800 px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-300">
            ...
            <div className="flex items-center">
              ...
              <span className="text-xl font-semibold text-gray-800 dark:text-white">PanchVeda</span>
            </div>
          </div>
        </div>

        {/* Main Content */}
        <div className="flex justify-center px-4 pt-8 bg-green-50 dark:bg-gray-900">
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm p-8 w-full max-w-md">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
                {isLogin ? 'Welcome Back' : 'Join PanchVeda'}
              </h1>
